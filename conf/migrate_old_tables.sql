;-- This SQL file will migrate tables from an old, finnish version of Kirjuri
;-- to the new version used by the Open Source version. Do NOT run this SQL file
;-- without backing up your database because it WILL truncate your existing
;-- new format tables.
;--
;-- If you are installing Kirjuri for the first time, run create_tables.sql
...
TRUNCATE TABLE kirjuri_db.exam_requests;

TRUNCATE TABLE kirjuri_db.event_log;

INSERT INTO kirjuri_db.exam_requests SELECT * FROM tutkinta.jutut;
