...
$query = $kirjuri_database->prepare('select id, parent_id, device_type, device_manuf, device_model FROM exam_requests WHERE parent_id = :parent_id AND id != :parent_id');
$query->execute(array(
    ':parent_id' => $casefetch['parent_id']
));
